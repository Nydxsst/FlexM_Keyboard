...
void NRF24L01_EXTI_IRQHandler(void)
{
	...
	//ST7735S_CPT144_DispString_XDir(1 ,2*8+1, "Interrupt");
	if(EXTI_GetITStatus(NRF24L01_EXTI_LINE) != RESET)
	{
		...
		if(sta & MAX_TX) //达到最大重发次数
		{
			...
			//ST7735S_CPT144_DispString_XDir(1 ,4*8+1, "MAX_TX");
		...
		{
			//ST7735S_CPT144_Clear();
			//ST7735S_CPT144_DispString_XDir(1 ,6*8+1, "TX_OK");
		...
		{
			//ST7735S_CPT144_Clear();
			//ST7735S_CPT144_DispString_XDir(1 ,8*8+1, "RX_OK");//发送方连续发送会导致屏幕还没
